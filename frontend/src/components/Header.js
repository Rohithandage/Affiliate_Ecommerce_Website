...
const Header = () => {
  ...
  return (
    <header className='h-16 shadow-md  bg-white fixed w-full z-40'>
      <div className=' h-full container gap-1 mx-auto flex items-center  justify-between'>
            <div className=''>
                <Link to={"/"}>
                <Logo w={100} h={90}/>
                </Link>
            ...
            { <div className=' gap-7 flex items-center w-full justify-between max-w-sm border rounded-full focus-within:shadow pl-2'>
